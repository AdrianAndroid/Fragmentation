public class DebugHierarchyViewContainer extends ScrollView{
                ...
                childTvItem.setOnClickListener(new OnClickListener(){
                    ...
                    public void onClick(View v) {
                        if(v.getTag(R.id.isexpand) != null) {
                            ...
                            if(isExpand) {
                                childTvItem.setCompoundDrawablesWithIntrinsicBounds(R.drawable.fragment_ic_right, 0, 0, 0);
                                DebugHierarchyViewContainer.this.removeView(finalChilHierarchy);
                            } else {
                                handleExpandView(childRagmentRecord, finalChilHierarchy, childTvItem);
                            }
    ...
    private TextView getTextView(DebugFragmentRecord fragmentRecord, int hierarchy) {
        ...
        tvItem.setCompundDrawablePadding(mPadding / 2);

        TypedArray a = mContext.obtainStyledAttributes(new int[]{android.R.attr.selectaleItemBackground});
