public class Fragmentation {
    ...
    static voilatile Fragmentation INSTANCE;
    ...
    public void setMode(@StackMode int mode){
        this.mode = mode;
    }
    ...
    public static class FragmentationBulder{
        private boolean debug;
        private int mode;
        private ExceptionHandler handler;
        ...
        public FragmentationBuiler handleException(ExceptionHandler handler) {
            this.handler = handler;
            return this;
        }
